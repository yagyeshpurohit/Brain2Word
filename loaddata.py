...
def dataloader_sentence_word_split_new_matching_all_subjects(subject):
    ...
    data_train = np.zeros((3903,65730)) 
    data_fine = np.zeros((7560,65730)) 
    data_test = np.zeros((627,65730))  
    data_fine_test = np.zeros((540,65730))

    glove_train = np.zeros((3903,300))   
    glove_fine = np.zeros((7560,300))   
    glove_test = np.zeros((627,300))  
...
data_train, data_fine_test, glove_train, glove_fine_test, data_fine, data_fine_test, glove_fine, glove_fine_test = dataloader_sentence_word_split_new_matching_all_subjects('/M02')
